    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        if (op.equals("borrar")) {
            ...
            if (Crud.destroyProducto(id) > 0) {
                request.setAttribute("mensaje", "Productos con id " + id + "Borrado");
            } else {
                request.setAttribute("mensaje", "NO se ha podido borrar ningun producto");
            }
        ...
        if (op.equals("actualizardatos")) {
            ...
            if (Crud.actualizaProducto(miProducto) > 0) {
                request.setAttribute("mensaje", "Productos con id " + id + "Actualizado");
            } else {
