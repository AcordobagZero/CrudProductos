    ...
    <body>
        <div class="container">
            ...
            <%
                ...
                if( mensaje != null) {
                    out.print("<h2 class='alert alert-success'>" + mensaje + "</h2>");
                } else {
            ...
            <table class="table">
                ...
                <tr>
                    ...
                    <td><%=p.getPrecio()%>€</td>
                    <td><%=p.getId()%> </td>
                    <td><a href="Servlet?op=borrar&id=<%=p.getId()%>" onclick="return Confirmacion()">Borrar</a>
        ...
        <script>
            function Confirmacion() {
                if (confirm("¿Está segur@ de que quiere eliminar el producto?")) {
